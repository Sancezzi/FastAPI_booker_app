...
@pytest.mark.parametrize("location,date_from,date_to,status_code,detail", [
    ("Алтай", "2023-01-01", "2022-01-10", 400, "Check-in date cannot be later than check-out date"),
    ("Алтай", "2023-01-01", "2023-02-10", 400, "It is impossible to book a hotel for more than a month"),
